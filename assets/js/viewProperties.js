(($) => {
  ...
  $('.btn-grid').click(() => {
    ...
    $('.btn-list').removeClass('active col-lg-4');
    $('.btn-map').removeClass('active col-lg-4');
    $('.property .property-item').addClass('flex-column');
    $('.property .property-item').removeClass('align-items-center');
    $('.mapProps').removeClass('align-items-center');
  ...
  // $('.btn-map').click(() => {
  //   $('.mapProps').addClass('active');
  //   $('.property').removeClass('col-lg-12');
  //   $('.btn-list').removeClass('active');
  //   $('.btn-grid').removeClass('active col-lg-4');
  //   $('.btn-map').addClass('active');
  //   $('.property .property-item').removeClass('flex-row align-items-center');
  //   $('.property .property-item').removeClass('flex-column');
  //   $('.mapProps').addClass('col-lg-10 align-items-center');
  //   $('.item-info').removeClass('w-75');
  //   $('.item-info').removeClass('w-100');
  //   $('.item-info small').removeClass('border-top');
  //   $('.properties').removeClass('');
  // });
